...
select uuid(),"invoice",invoice_date,amount_cents,currency,tax_code,id,order_id,payment_method,line_items,customer_account,customer_company,customer_name,customer_address_1,customer_address_2,customer_zip,customer_city,customer_state,customer_country,vat_included,replaces_id,replaced_by_id,created_at,updated_at,sales_account from invoices;
